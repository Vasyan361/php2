...
abstract class Model implements Validation
{
    ...
    public static function findAll()
    {
        ...
        return $db->queryEach($sql, [], static::class); // логичнее всего использовать здесь, так как у нас может быть
        // миллион новостей и генератор позволит не забивать память
    }
